    ...
    Public Class RolPorDepartamentoController
        ...
        Function Create(<Bind(Include:="ID,Nombre,DepartamentoID")> ByVal rolPorDepartamento As RolPorDepartamento) As ActionResult
            ...
            For i = 0 To db.rolPorDepartamento.ToArray.Length - 1
                ...
                End If
            Next
            rolPorDepartamento.FechaCreacion = DateTime.Now
            rolPorDepartamento.FechaModificacion = rolPorDepartamento.FechaCreacion
        ...
        Function Edit(<Bind(Include:="ID,Nombre,DepartamentoID,FechaCreacion,FechaModificacion")> ByVal rolPorDepartamento As RolPorDepartamento) As ActionResult
            rolPorDepartamento.FechaModificacion = DateTime.Now
            If ModelState.IsValid Then
