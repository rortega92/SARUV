...
Namespace Migrations
    ...
    Public NotInheritable Partial Class TablaIntermediaRecursoPorUsuario
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TablaIntermediaRecursoPorUsuario))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201505240424309_TablaIntermediaRecursoPorUsuario"
            End Get
        End Property
