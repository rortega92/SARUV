...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ReferenceData
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ReferenceData))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201506050032368_ReferenceData"
            End Get
        End Property
