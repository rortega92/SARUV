...
Namespace Migrations
    ...
    Partial Public NotInheritable Class EventoEstudio
        Implements IMigrationMetadata

        Private ReadOnly Resources As New ResourceManager(GetType(EventoEstudio))

        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201506081900204_EventoEstudio"
            End Get
        End Property
