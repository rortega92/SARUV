...
Namespace Migrations
    ...
    Public NotInheritable Partial Class NoDescriptionRequiredCalendario
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(NoDescriptionRequiredCalendario))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201506230438425_NoDescriptionRequiredCalendario"
            End Get
        End Property
