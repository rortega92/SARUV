        ...
        @Using (Html.BeginForm())
            ...
            @<div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                       @Html.JQueryUI().DatepickerFor(Function(model) model.FechaInicio, New With {.htmlAttributes = New With {.class = "form-control"}}).minDate(DateTime.Today)
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.JQueryUI().DatepickerFor(Function(model) model.FechaFinal, New With {.htmlAttributes = New With {.class = "form-control", .oninput = "Test()"}}).minDate(DateTime.Today)
