                    ...
                    <div class="form-group">
                        <div class="modal-footer">
                            @If User.IsInRole("Admin").Equals(True) Then
                                @<a class="btn btn-default btn-sm" id="modalEdit" href="/EventosCalendario/Edit/"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="modalTitle" class="modal-title">Crear Evento</h4>
            </div>
            <div id="modalBody" class="modal-body">
                ...
                @Using (Html.BeginForm("Create", "EventosCalendarios"))
                    ...
                    @<div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                @Html.JQueryUI().DatepickerFor(Function(model) model.FechaReserva, New With {.class = "form-control", .id = "inicio"}).MinDate(DateTime.Today)
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             <label for="Description" class="control-label col-md-2">Descripción</label>
                             <div class="col-md-10">
